...
if __name__ == '__main__':
    ...
    #
    # features = features + df.columns[df.columns.str.contains('rolling_avg_100') |
    ...
    #     'use_embedding' : True,
    #     'seed' : 1,
    #     'log_dir': '../output/neural_network_training/embedding/'
    # }
    #
    #
    # epochs = model.train(args, early_stopping = True, patience = 25, train_dataset = train_loader, valid_dataset = valid_loader)
    #
    ...
    #
    # profit, nn_cum_profit = utils.backtest(y_pred_binary, y_test_pred, 'nn_model4')
